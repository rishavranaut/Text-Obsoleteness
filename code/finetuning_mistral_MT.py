...
save_directory = "./mistral_MT_merged"
...
AutoModelForCausalLM.from_pretrained(save_directory).push_to_hub("13ari/mistral_MT")
AutoTokenizer.from_pretrained(save_directory).push_to_hub("13ari/mistral_MT")
