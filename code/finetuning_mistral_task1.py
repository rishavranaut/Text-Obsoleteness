...
save_directory = "./mistral_Task1_merged"
...
AutoModelForCausalLM.from_pretrained(save_directory).push_to_hub("13ari/mistral_Task1")
AutoTokenizer.from_pretrained(save_directory).push_to_hub("13ari/mistral_Task1")
