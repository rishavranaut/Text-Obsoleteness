...
save_directory = "./qwen2_Task1_merged"
...
AutoModelForCausalLM.from_pretrained(save_directory).push_to_hub("13ari/Qwen2_Task1")
AutoTokenizer.from_pretrained(save_directory).push_to_hub("13ari/Qwen2_Task1")
