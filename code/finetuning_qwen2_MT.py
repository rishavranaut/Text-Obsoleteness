...
save_directory = "./qwen2_MT_merged"
...
AutoModelForCausalLM.from_pretrained(save_directory).push_to_hub("13ari/qwen2_MT")
AutoTokenizer.from_pretrained(save_directory).push_to_hub("13ari/qwen2_MT")
