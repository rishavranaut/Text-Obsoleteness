...
save_directory = "./qwen2_Task2_merged"
...
AutoModelForCausalLM.from_pretrained(save_directory).push_to_hub("13ari/qwen2_Task2")
AutoTokenizer.from_pretrained(save_directory).push_to_hub("13ari/qwen2_Task2")
