...
save_directory = "./llama3_Task2_merged"
...
AutoModelForCausalLM.from_pretrained(save_directory).push_to_hub("13ari/llama3_Task2")
AutoTokenizer.from_pretrained(save_directory).push_to_hub("13ari/llama3_Task2")
