...
save_directory = "./flanT5_Task1_merged"
...
AutoModelForSeq2SeqLM.from_pretrained(save_directory).push_to_hub("13ari/flanT5_Task1")
AutoTokenizer.from_pretrained(save_directory).push_to_hub("13ari/flanT5_Task1")
